...
const options = {
    definition: {
        ...
        servers: [{ url: "http://localhost:5000/api" }],  // Updated base path
        components: {
            schemas: {
                // User Signup Schema
                UserSignup: {
                ...
                // Post Schema (Updated for file uploads)
                Post: {
                    type: "object",
                    ...
                    properties: {
                        ...
                        images: {
                            type: "array",
                            items: { type: "string", format: "binary" },  // Important for file uploads
    ...
    apis: ["./routes/userRoutes.js", "./routes/postRoutes.js", "./routes/profileRoutes.js"],  // Updated path
};
